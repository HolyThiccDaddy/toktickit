...
**Author:** Thira Rungruangkaset — 67070503419 — GitHub: [@HolyThiccDaddy](https://github.com/HolyThiccDaddy)
**Peer reviewer:** Ashira Sansoda — 67070503445 — GitHub: [@osizk](https://github.com/osizk)

## Pull Requests authored for Lab 2

| Issue | Pull request | Branch | Merge commit | Reviewer status |
|---|---|---|---|---|
| #6 Database Schema and Idempotent Seed | [#20](https://github.com/HolyThiccDaddy/toktickit/pull/20) | `feature/6-db-seed` | `81d1c33` | Approved and merged |
| #7 Requester Context | [#21](https://github.com/HolyThiccDaddy/toktickit/pull/21) | `feature/7-requester-context` | `37f7e40` | Approved and merged |
